...
* SaveMessageListener - оперирует с моделью Message сохраняет в нужные таблицы
* SaveMessageToQueueListener - оперирует с моделью Message отправляет данные в очередь на отправку в ws
...
* SaveDonateListener - оперирует с моделью Donate и Message сохраняет в нужные таблицы и если нужно сохраняет модель сообщения
...
* SaveNewSponsor - необходимо сохранить нового спонсора для определенной модели.
